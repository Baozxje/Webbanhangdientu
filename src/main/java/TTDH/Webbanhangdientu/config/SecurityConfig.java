...
import TTDH.Webbanhangdientu.authentication.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    // Sử dụng @Lazy để tránh lỗi "Circular Dependency" (vòng lặp vô tận khi khởi tạo Bean)
